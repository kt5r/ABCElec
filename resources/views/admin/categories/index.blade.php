...
@section('title', __('categories.browse_categories'))

@section('content')
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-8">{{ __('categories.browse_categories') }}</h1>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <h3 class="text-xl font-semibold text-gray-800 text-center mb-2">
                    {{ __('categories.' . strtolower($category->name)) }}
                </h3>
